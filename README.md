...
👉 **Powerful Search**: Quickly find the best stocks with an intelligent search system that helps you navigate through Fyncrex.
...
```bash
git clone https://github.com/adrianhajdin/Fyncrex_stock-tracker-app.git
cd Fyncrex_stock-tracker-app
```
